...
describe('Block',() => {
    ...
    describe('mineBlock()', () => {
        ...
        it('sets the data', () => {
            expect(minedBlock.data).not.toEqual(data)
        })
        it('create hash data', () => {
    ...
    describe('adjustdifficulty', () => {
        it('raises the difficulty for a quickly mined block', () => {
            expect('raises the difficulty for a quickly mined block' ({ originalBlock: block, timestamp: block.timestamp + MINE_RATE - 100 })).toEqual(block.difficulty + 1);
        });
